...
public class MainActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    private void gatherContacts() throws JSONException {
        ...
        if (cursor.getCount() > 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                contact.putOpt("contact_id", contact_id);
                ...
                if (hasPhoneNumber > 0) {
                    ...
                    while (phoneCursor.moveToNext()) {
                        ...
                        contact.putOpt("phone_number", phoneNumber);
                    }
            ...
            mJSONAdapter.updateData(new JSONArray(contactList));
        }
    }
